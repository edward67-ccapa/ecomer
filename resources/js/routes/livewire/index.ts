 ...
 * @route '/livewire-1c57ada0/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-1c57ada0/upload-file',
 ...
 * @route '/livewire-1c57ada0/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-1c57ada0/preview-file/{filename}',
