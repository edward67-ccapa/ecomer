...
* @route '/livewire-2d932d37/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-2d932d37/upload-file',
...
* @route '/livewire-2d932d37/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-2d932d37/preview-file/{filename}',
