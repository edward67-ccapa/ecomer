...
* @route '/livewire-8d8202d9/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-8d8202d9/upload-file',
...
* @route '/livewire-8d8202d9/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-8d8202d9/preview-file/{filename}',
