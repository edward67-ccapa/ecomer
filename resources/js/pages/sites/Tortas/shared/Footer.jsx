...
export default function Footer({
    ...
    // Enlaces de navegación con resolución de URL limpia y scroll a anclas (Tortas tiene páginas para inicio, productos, servicios)
    const getSectionHref = (seccion) => {
        ...
        const standaloneSlugs = ['inicio', 'productos', 'servicios'];
    ...
    const getActionLink = (item) => {
        ...
        if (ico.includes('whatsapp') || firstLine.includes('wa.me')) {
            ...
            return waNum ? `https://wa.me/${waNum}?text=${encodeURIComponent('Hola! Quisiera realizar un pedido.')}` : null;
        }
